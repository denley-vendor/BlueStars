...
public:
	...
	DWORD SetBitmaps(int nBitmapNormal,int nBitmapHot,int nBitMapClick, COLORREF crTransColorIn, int nBitmapOut = NULL, COLORREF crTransColorOut = 0);
	DWORD SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0);
	DWORD SetBitmaps(HBITMAP nBitmapNormal,HBITMAP nBitmapHot,HBITMAP nBitMapClick, COLORREF crTransColorIn, int nBitmapOut = NULL, COLORREF crTransColorOut = 0);
